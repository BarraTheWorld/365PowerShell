...
#Don't change the order of these switches
$switches = @("192.168.50.8","192.168.50.13","192.168.50.11","192.168.50.3","192.168.50.2","192.168.50.4","192.168.50.5","192.168.50.252","192.168.50.253")

foreach ($sw in $switches) {
	Get-Telnet -RemoteHost $sw -Port 60000  -Commands "USERNAME","PASSWORD","enable","show sysinfo","q","reload","y","y" -waitTime 300 -OutputPath ("SwitchRestartLogs\SwitchReloadScript-" + (Get-Date -Format "yyyyMMdd_HHmm_") +$sw + ".txt")
